...
use SafoorSafdar\AuthorizeNet\Request\Cim\DeleteCustomerProfile;

use net\authorize\api\contract\v1 as AnetAPI;
use net\authorize\api\controller as AnetController;

class DeleteCustomerProfileAction extends GatewayAwareAction implements
    ApiAwareInterface
{
    /**
     * @var AuthorizeNet
    ...
    public function execute($request)
    {
        ...
        $controller
            = new AnetController\DeleteCustomerProfileController($request);
        $response
    ...
    {
        return $request instanceof DeleteCustomerProfile
